...
def read_cfgs():
    ...
    parser.add_argument("--off_flownet", action="store_true",
                        help="offline inference for flownet")
    parser.add_argument("-seq", type=str,
                        default=10, help="sequence index for kitti odom")
    parser.add_argument("--save_pose", action="store_true",
                        help="save odometry pose data as npy files")
    parser.add_argument("--load_pose", action="store_true",
                        help="load odometry pose data from npy files")
    ...
    if args.off_flownet:
        cfg.off_flownet = True
    else:
        cfg.off_flownet = False
