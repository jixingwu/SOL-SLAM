...
from .resnet_lora import resnet18
...
class ResnetEncoder(nn.Module):
    ...
    def __init__(self, num_layers, pretrained, lora_r, num_input_images=1):
        ...
        if num_input_images > 1:
            ...
            if pretrained:
                self.encoder = resnets[num_layers](lora_r, weights="IMAGENET1K_V1")
            else:
                self.encoder = resnets[num_layers](lora_r)
