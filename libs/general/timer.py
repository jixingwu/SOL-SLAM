...
class Timer():
    ...
    def __init__(self, cfg, items=None):
        """
        Args:
    ...
    def time_analysis_to_txt(self):
        """Time analysis of the items and save to txt file
        """
        import os
        time_path = os.path.join(self.cfg.directory.result_dir, f'{self.cfg.online_learning.mode}_{self.cfg.online_learning.lora_r}_time_analysis.txt')
        # 打开文件以写入模式
